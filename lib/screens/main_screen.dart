...
class _MenuGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = <_MenuItem>[
      _MenuItem(label: '회화', sub: 'Conversación', badge: 'Ch', color: AppColors.rojo,
        builder: (_) => const ConversationScreen()),
      _MenuItem(label: '문법', sub: 'دستور', badge: 'G', color: AppColors.rojoDeep,
        builder: (_) => const GrammarHubScreen()),
      _MenuItem(label: '문장 카드', sub: 'جمله‌ها', badge: 'S', color: AppColors.tinta,
        builder: (_) => const SentenceFlashcardScreen()),
      _MenuItem(label: '말하기', sub: 'صحبت', badge: '🎙', color: AppColors.rojo,
        builder: (_) => const SpeakingPracticeScreen()),
      _MenuItem(label: '청크 검색', sub: 'جستجو', badge: '🔍', color: AppColors.gualdaDeep,
      ...
      _MenuItem(label: '발음', sub: 'Pronunciación', badge: 'rr', color: AppColors.er,
        builder: (_) => const _ComingSoon(title: '발음 (rr · ñ · 강세)')),
      _MenuItem(label: '단어 카드', sub: 'کارت‌ها', badge: 'R', color: AppColors.gualdaDeep,
