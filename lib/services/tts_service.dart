...
/// flutter_tts 기반 — 시스템 fa-IR voice 사용.
///
/// 화자별 음성: 기기에 남/여 es 보이스가 있으면 voice 전환,
/// 없으면 피치(남 0.72 / 여 1.12)로 구분한다.
class TtsService {
  TtsService._();
  static final TtsService instance = TtsService._();

  static const String locale = 'fa-IR';
  ...
  /// es 보이스 중 이름에 male/female 힌트가 있는 것을 1회 스캔.
  Future<void> _scanVoices() async {
    ...
    try {
      ...
      for (final v in voices) {
        ...
        if (!vLocale.toLowerCase().startsWith('fa')) continue;
