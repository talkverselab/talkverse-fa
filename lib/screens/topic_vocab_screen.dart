...
/// co-Trip 여행 페르시아어 — 주제별 단어·표현 (chinese-universe 포팅).
class VocabWord {
  final String ko;
  final String tx; // 스페인어
...
/// 1×1 단어 타일 — 아이콘 + 스페인어 + 독음 + 뜻. 외우기 모드 지원.
