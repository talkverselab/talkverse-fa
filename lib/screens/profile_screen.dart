      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                const TileBadge(text: 'FA', size: 60, color: AppColors.tinta),
                SizedBox(width: 14),
                Expanded(
                  child: Column(
          ...
          _SettingsGroup(items: [
            ...
            _SettingItem(icon: Icons.volume_up, title: tr('TTS 음성'), subtitle: tr('fa-IR (시스템 보이스)')),
            _SettingItem(icon: Icons.public, title: tr('변종'), subtitle: tr('카스티야 (España) · vosotros')),
          ...
          _SettingsGroup(items: [
            ...
            _SettingItem(icon: Icons.copyright, title: tr('저작권'), subtitle: tr('페르시아어유니버스 · 2026')),
          ]),
