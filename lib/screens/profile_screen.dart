      ...
      body: ListView(
        ...
        children: [
          ...
          _SettingsGroup(items: [
            _SettingItem(icon: Icons.volume_up, title: 'TTS 음성', subtitle: 'fa-IR (시스템 보이스)'),
            _SettingItem(icon: Icons.public, title: '변종', subtitle: '카스티야 (España) · vosotros'),
          ...
          _SettingsGroup(items: [
            ...
            _SettingItem(icon: Icons.copyright, title: '저작권', subtitle: '페르시아어유니버스 · 2026'),
          ]),
