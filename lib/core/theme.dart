...
/// España 컬러 팔레트 — 국기 rojo·gualda + 석회벽 백색·올리브·지중해 청색
class AppColors {
  // 主色 — Rojo (국기 빨강)
  static const Color rojo = Color(0xFF239F40);
  static const Color rojoDeep = Color(0xFF17702C);
  static const Color rojoLight = Color(0xFF4CBB68);

  // 副色 — Gualda (국기 노랑/금)
  static const Color gualda = Color(0xFFDA0000);
  static const Color gualdaBright = Color(0xFFF04A4A);
  static const Color gualdaDeep = Color(0xFF9E0000);
